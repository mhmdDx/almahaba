...
export function CompactsGalleryClient() {
    const t = useTranslations("Compacts")
        ...
        <div className="min-h-screen bg-neutral-900 text-white">
            ...
            <section className="relative py-24 md:py-32 overflow-hidden pt-30">
                ...
                <div
                    ...
                    style={{ backgroundImage: "url('/compacts.jfif')" }}
                />
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        {images.map((src, index) => (
                            ...
                            >
                                <Image
                                    src={src}
                                    alt={`Compact Laminate Design ${index + 1}`}
                                    fill
                                ...
                                {row1Images.map((src, index) => (
                                    <div key={index} className="flex-[0_0_50%] min-w-0 pl-4">
                                        ...
                                        >
                                            <Image
                                                src={src}
                                                alt={`Compact Laminate Design Row 1-${index + 1}`}
                                                fill
                                                className="object-cover transition-transform duration-700 group-hover:scale-110"
                                ...
                                {row2Images.map((src, index) => (
                                    <div key={index} className="flex-[0_0_50%] min-w-0 pl-4">
                                        ...
                                        >
                                            <Image
                                                src={src}
                                                alt={`Compact Laminate Design Row 2-${index + 1}`}
                                                fill
                                                className="object-cover transition-transform duration-700 group-hover:scale-110"
                                                sizes="(max-width: 640px) 50vw, 33vw"
                                            />
