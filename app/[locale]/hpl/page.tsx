...
export default function HPLGallery() {
    const t = useTranslations("HPL")
    const locale = useLocale()
    const direction = locale === 'ar' ? 'rtl' : 'ltr'

    const [emblaRef1, emblaApi1] = useEmblaCarousel({ loop: true, align: "start", direction }, [Autoplay({ delay: 3000 }) as any])
    const [emblaRef2, emblaApi2] = useEmblaCarousel({ loop: true, align: "start", direction }, [Autoplay({ delay: 3500 }) as any]) // Slight delay diff
        ...
        <div className="min-h-screen bg-neutral-900 text-white">
            ...
            <section className="relative py-24 md:py-32 overflow-hidden pt-30">
                ...
                <div
                    ...
                    style={{ backgroundImage: "url('/hpl.jfif')" }}
                />
